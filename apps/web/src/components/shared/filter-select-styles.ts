...
export const FILTER_SEARCH_CLASS =
  "h-9 w-full min-w-[200px] sm:w-[240px] rounded-sm border border-border-default bg-bg-surface pl-9 pr-3 text-body-sm text-text-primary placeholder:text-text-tertiary transition-colors duration-[120ms] focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-[color:var(--color-border-focus)]/40"
