...
import { makeExamWithMixedTypes, makeExamWithQuestions, makeExamWithValidation } from "./fixtures.js"
import { getLoader, mockApiResolvedValueOnce, mockExamsGet, renderReviewPage, setReviewSearch } from "./setup.js"
...
describe("ReviewPage — Task 13: Fast mode badges show correct label per type", () => {
  it("mcq_multi question badge shows \"Kunci A, C\"", async () => {
    ...
    mockApiResolvedValueOnce(mockExamsGet, makeExamWithMixedTypes("exam_mixed"))
  ...
  it("true_false question badge shows \"Kunci B, S, B\"", async () => {
    ...
    mockApiResolvedValueOnce(mockExamsGet, makeExamWithMixedTypes("exam_mixed2"))
...
describe("ReviewPage — Task 13: Slow mode card highlights correctly", () => {
  it("mcq_multi card highlights both correct letters A and C", async () => {
    ...
    mockApiResolvedValueOnce(mockExamsGet, makeExamWithMixedTypes("exam_mixed_slow"))
  ...
  it("true_false card shows 3 statement rows with B/S indicators", async () => {
    ...
    mockApiResolvedValueOnce(mockExamsGet, makeExamWithMixedTypes("exam_mixed_slow2"))
