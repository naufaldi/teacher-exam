    ...
    <div className="max-w-3xl space-y-8">
      ...
      <Card className="p-5 space-y-3 border-warning-border bg-warning-bg/30">
        ...
        <p className="text-body-sm text-text-secondary">
          Jika pratinjau menampilkan <strong>imes</strong> (huruf miring), backslash hilang.
          Perbaiki dengan menulis <code className="font-mono bg-kertas-100 px-1">\times</code>{' '}
          di dalam $...$.
        </p>
      ...
      <Card className="p-5">
        ...
        <p className="text-body-sm text-text-secondary">
          Angka dengan titik pemisah ribuan (mis. 5.678, 1.824) tulis sebagai teks biasa —{' '}
          <strong>jangan</strong> masukkan ke dalam $...$. Di dalam $...$, titik dianggap desimal
          oleh LaTeX.
        </p>
      </Card>
    </div>
