...
export function buildPembahasanGradeRules(grade: number): ReadonlyArray<string> {
  if (grade <= 5) {
    return [
...
export function buildGeneralPembahasanRules(subject: string, grade: number): ReadonlyArray<string> {
  return [
...
function buildMatematikaPembahasanRules(): ReadonlyArray<string> {
  return [
    "Aturan Matematika:",
...
function buildBahasaIndonesiaPembahasanRules(): ReadonlyArray<string> {
  return [
...
function buildPpknPembahasanRules(): ReadonlyArray<string> {
  return [
...
function buildIpasPembahasanRules(): ReadonlyArray<string> {
  return [
    "Aturan IPAS:",
...
function buildBahasaInggrisPembahasanRules(): ReadonlyArray<string> {
  return [
...
function buildKnownSubjectRules(key: KnownSubjectKey): ReadonlyArray<string> {
...
export function buildPembahasanSubjectRules(subject: string, grade: number): ReadonlyArray<string> {
  const normalized = normalizeSubjectLabel(subject)
