  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected: "[&>button]:bg-primary-500 [&>button]:text-text-on-primary [&>button]:hover:bg-primary-600",
        ...
        range_middle: "bg-kertas-100 [&>button]:rounded-none [&>button]:bg-transparent [&>button]:hover:bg-transparent",
